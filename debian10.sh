...
# Your SSH Banner
SSH_Banner='https://raw.githubusercontent.com/beam98/auto-installer/main/issue.net'
...
function InstWebmin(){
 ...
 WebminFile='https://raw.githubusercontent.com/beam98/auto-installer/main/webmin_1.920_all.deb'
...
wget -O menu "https://raw.githubusercontent.com/beam98/auto-installer/main/menu.sh"
	wget -O user-add "https://raw.githubusercontent.com/beam98/auto-installer/main/user-add.sh"
	wget -O trial "https://raw.githubusercontent.com/beam98/auto-installer/main/trial.sh"
	wget -O user-del "https://raw.githubusercontent.com/beam98/auto-installer/main/hapus.sh"
	wget -O user-login "https://raw.githubusercontent.com/beam98/auto-installer/main/user-login.sh"
...
if [[ "$ID" != 'debian' ]]; then
 ...
 cd ~
  ...
  # Running screenfetch
 wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/beam98/auto-installer/main/screenfetch"
 ...
 # info
	...
	echo "SSL      : 446, 444"  | tee -a log-install.txt
	echo "Squid3   : 8080, 3128 (limit to IP SSH)"  | tee -a log-install.txt
	echo "OpenVPN  : TCP 443, UDP 25000 (client config : http://$MYIP:81/tvpudp.zip)"  | tee -a log-install.txt
